...
if (beEmpty(sFunction) || sFunction.length()<1){
...
if (sFunction.equals("DoAuthCheck")){
	...
	//sResponse = DoAuthCheck(sRequest);
	bSendToBSC = false;
}

if (sFunction.equals("GetDMSStoreAddressId") || sFunction.equals("DoSend2VSP")){	//這兩個放在BSC目錄底下
